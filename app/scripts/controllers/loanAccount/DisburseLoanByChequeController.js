(function (module) {
    mifosX.controllers = _.extend(module, {
        DisburseLoanByChequeController: function (scope, routeParams, route, location, resourceFactory, http, $uibModal, API_VERSION, $timeout, $rootScope, Upload) {
    ...
    mifosX.ng.application.controller('DisburseLoanByChequeController', ['$scope', '$routeParams', '$route', '$location', 'ResourceFactory', '$http', '$uibModal', 'API_VERSION', '$timeout', '$rootScope', 'Upload', mifosX.controllers.DisburseLoanByChequeController]).run(function ($log) {
